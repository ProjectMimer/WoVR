...
class cIDirect3DDevice9 : public IDirect3DDevice9Ex
{
public:
	cIDirect3DDevice9(IDirect3DDevice9Ex* pOriginal, bool showLog, std::stringstream* log);
...
private:
	...
	bool doLog = true;
	IDirect3DDevice9Ex* m_pIDirect3DDevice9;
	ULONG m_nRefCount;
};
