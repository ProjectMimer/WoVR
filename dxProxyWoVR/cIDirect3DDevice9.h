...
{
public:
	cIDirect3DDevice9(IDirect3DDevice9* pOriginal, bool showLog, std::stringstream* log);
	virtual ~cIDirect3DDevice9();
...
class cIDirect3DDevice9Ex : public IDirect3DDevice9Ex
{
public:
	cIDirect3DDevice9Ex(IDirect3DDevice9Ex* pOriginal, bool showLog, std::stringstream* log);
	virtual ~cIDirect3DDevice9Ex();
